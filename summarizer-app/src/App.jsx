...
function App() {
  ...
  const handleShare = () => {
    ...
    const subject = encodeURIComponent("Meeting Notes Summary");
    const body = encodeURIComponent(summary);

    // Open Gmail compose window
    const mailtoUrl = `https://mail.google.com/mail/?view=cm&fs=1&to=${recipients}&su=${subject}&body=${body}`;
  ...
  return (
    <div className="container">
      <header className="app-header">
        ...
        <p>
          Upload a transcript, provide instructions, and get a summary
          instantly.
        </p>
      </header>
      ...
      <footer className="app-footer">Developed by Aditya Singh Negi</footer>
    </div>
  );
}
